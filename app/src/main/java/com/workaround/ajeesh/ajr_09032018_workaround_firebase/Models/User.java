 ...
 * Created by ajesh on 11-03-2018.
...
public class User {
    ...
    public User(String name, String phone, String profile_image, String security_level, String user_id, String messaging_token, String department) {
        this.name = name;
        this.phone = phone;
